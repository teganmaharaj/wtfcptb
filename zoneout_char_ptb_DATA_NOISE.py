...
def train(step_rule, input_dim, state_dim, label_dim, layers, epochs,
    ...
    def crossentropy_timesteps(yhat, y):
        # for sequence of distributions/targets
        return (-(y * T.log(yhat)).sum(axis=yhat.ndim - 1)).mean(axis=-1)
    ...
    cross_entropies_timesteps = crossentropy_timesteps(yhat, y)
    costs = cross_entropies_timesteps.copy(name="costs")
